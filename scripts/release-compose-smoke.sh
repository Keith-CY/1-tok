...
ONE_TOK_SERVICE_TOKEN="${ONE_TOK_SERVICE_TOKEN:-local-service-token}"
...
cleanup() {
  ...
  (
    ...
    ONE_TOK_SERVICE_TOKEN="${ONE_TOK_SERVICE_TOKEN}" \
...
RELEASE_SMOKE_SETTLEMENT_SERVICE_TOKEN="${ONE_TOK_SERVICE_TOKEN}" \

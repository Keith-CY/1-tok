...
SETTLEMENT_INTERNAL_TOKEN="${SETTLEMENT_INTERNAL_TOKEN:-local-settlement-service-token}"
...
DEPENDENCY_FIBER_HEALTHCHECK_URL="${DEPENDENCY_FIBER_HEALTHCHECK_URL:-}"
...
require_env "DEPENDENCY_CARRIER_GATEWAY_URL" "${DEPENDENCY_CARRIER_GATEWAY_URL}"
require_env "DEPENDENCY_CARRIER_GATEWAY_API_TOKEN" "${DEPENDENCY_CARRIER_GATEWAY_API_TOKEN}"
...
RELEASE_SMOKE_SETTLEMENT_SERVICE_TOKEN="${SETTLEMENT_INTERNAL_TOKEN}" \

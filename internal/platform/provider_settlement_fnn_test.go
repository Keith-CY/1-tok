...
func TestFNNProviderSettlementProvisioner_TreatsAlreadyConnectedAsReconnectSuccess(t *testing.T) {
	const providerPeerID = "QmdWHo7ejoqhoXN56bFAWQtFtewPkrUSMA64Wp9XnB4n13"
